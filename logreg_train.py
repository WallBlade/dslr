...
def create_mini_batches(X, y, batch_size):
	...
	Returns: List of tuples, where each tuple contains a mini-batch of X and y.
	"""
...
def plot_cost_history(ax, cost_history, label):
	...
	label: Label for the plot (e.g., the house name).
	"""
...
def gradient_descent(X, y, ax, label):
	...
	Parameters: X: Input data ; y: Target data ; ax: Matplotlib axis object ; label: Label for the plot.
